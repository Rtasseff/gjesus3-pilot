...
**Last Updated:** 2026-06-18 — researcher Finder MVP built + global index published (branch `feat/finder-mvp`, see Section 0). Full dated history in [CHANGELOG.md](../CHANGELOG.md).
