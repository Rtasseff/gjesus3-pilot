...
**Last Updated:** 2026-06-23 — researcher Finder enhancements **merged to `main`** (auto-refresh of `index.html` on ingest; expanded columns incl. project `short_name` + owner; sidecar copy-path/metadata view; `DEFAULT_LINK_BASE` → container UNC). Prior: 2026-06-18 — full historical imaging archive in true production (~13,555 acqs; session checkpoint before a machine restart, see §0). Full dated history in [CHANGELOG.md](../CHANGELOG.md).
