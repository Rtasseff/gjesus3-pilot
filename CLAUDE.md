...
| `tasks/tasks.md` | Operational state — task list, open questions, future work, per-round detail trails. | Permanent rules (those belong in `mfb-rdm-docs/`); per-instrument workflow notes (those belong in `equipment/`). |
