...
def _seed(d):
    ...
    with open(os.path.join(regd, "registry_projects.csv"), "w", encoding="utf-8", newline="") as f:
        ...
        w.writerow(["PROJ-0003", "AE-biomaGUNE-0424", "AE biomaGUNE 0424 cardiac study",
                    "MBC", "", "active", "", "/projects/AE-biomaGUNE-0424/", ""])
    rows = [
        {"acq_id": "ACQ-20260219-ZWSI-001", "acquisition_datetime": "2026-02-19T00:00:00Z",
         ...
         "project_id": "PROJ-0003", "sample_type": "tissue", "file_size_mb": "120",
        ...
        {"acq_id": "ACQ-20251016-MRI-018", "acquisition_datetime": "2025-10-16T08:00:00Z",
         ...
         "researcher": "jrc", "project_id": "PROJ-0003",
        ...
        {"acq_id": "ACQ-20260101-CELL-001", "acquisition_datetime": "2026-01-01T00:00:00Z",
         "instrument": "CELL", "sample_id": "x", "project_id": "PROJ-9999",
...
def test_build_records():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        check(z["_project_folder"] == "/projects/AE-biomaGUNE-0424/", "project folder resolved")
        ...
        check(pz["proj_short"] == "AE-biomaGUNE-0424", "payload carries the project name")
...
def test_matches():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        check(f(project="PROJ-0003") == {"ACQ-20260219-ZWSI-001", "ACQ-20251016-MRI-018"}, "project filter (by id)")
        # Nobody remembers PROJ-ids — the name must filter too, case-insensitively.
        check(f(project="ae-biomagune-0424") == {"ACQ-20260219-ZWSI-001", "ACQ-20251016-MRI-018"}, "project filter (by name)")
