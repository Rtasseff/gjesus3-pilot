...
**Last Updated:** 2026-07-16 — MRI no-DICOM backfill official: deferred-regeneration tool + worklist status domain in [10_TOOLS §3.8](10_TOOLS.md), data-office procedure in [11_OPERATIONS §5.5](11_OPERATIONS.md). Recent index-level milestones are tabled under [Version History](#version-history) below; the full dated history lives in [CHANGELOG.md](../CHANGELOG.md).
