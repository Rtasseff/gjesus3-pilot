...
**Last Updated:** 2026-05-27 (Round-6 v2 internal MRI redo — `<ACQ-ID>.data/` flat-DICOM layout mirroring NI v2.1, parsed JCAMP-DX in sidecar, DICOM UIDs captured, no-DICOM acquisition handling for students who skip Bruker's exporter)
